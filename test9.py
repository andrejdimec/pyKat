...
arcpy.mp.CreateWebLayerSDDraft(
    ...
    folder_name="",  # Folder on ArcGIS Online (empty means root folder)
    overwrite_existing_service=True,  # Overwrite existing service with the same name
    summary="Web layer of the 'jasek_razno6' layer",  # Summary for the service
    tags="web layer, jasek_razno6, ArcGIS Online",  # Tags to describe the web layer
    description="This web layer is created from the 'jasek_razno6' layer in ArcGIS Pro",  # Detailed description
)
